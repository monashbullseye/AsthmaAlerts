                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-10 text-right menu-1">
                            <ul>
                                ...
                                <li><a href="Locked/DailyLogging.aspx">Daily Logging</a></li>
            ...
            <div class="row animate-box"> <%--HERE--%>
                <%--<div class="col-md-6 col-md-offset-3 text-center fh5co-heading">--%> <%--Changes 1--%>
                   ...
                   <div class="PostalCodeHeader">
                    <div class="Heading1">Today's Alerts</div> 
                    <p>Please enter your postal code </br>to check Asthma details!</p>
                    <div class="PostalCodeHeader">
                     
                        <asp:TextBox ID="txtCity" runat="server" Text="" width="40%" Height="20%"/>
                        <h2></h2>
                        <asp:Button ID="btn_getWeather" Text="Check Severity" runat="server" OnClick="btn_getWeather_Click"  />
                            ...
                            <div id="testingondiv" class="temp">
                             ...
                             <br> <asp:Label ID="lblCity_Country" runat="server" /> &nbsp;
                                ...
                                <div class="wtemp"><%--Temperature:(Min:--%>
                                    <asp:Label ID="lblTmpMX" text="Tempratture: Min:" runat="server" />
