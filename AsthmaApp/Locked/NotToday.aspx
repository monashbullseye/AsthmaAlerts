...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <%-- ************** Here integrating all wizard data into database **************** --%>

   <%-- <asp:AccessDataSource ID="AccessDataSource2" runat="server" DataFile="~/AsthmaKidsDB.accdb"
     InsertCommand="INSERT INTO [PersonalRecords] ([Year], [Month], [Day], [Time], [Activity], [Animal], [Food], [Accident]) VALUES (?, ?, ?, ?, ?, ?, ?, ?)" SelectCommand="SELECT * FROM [PersonalRecords]"> 
      
        <InsertParameters>
            <asp:FormParameter Name="Year" FormField="DdlTime" />
            <asp:FormParameter Name="Month" FormField="DdlTime" />
            <asp:FormParameter Name="Day" FormField="DdlTime" />
            <asp:FormParameter Name="Time" FormField="DdlTime" />
            <asp:FormParameter Name="Activity" FormField="DdlTime" />
            <asp:FormParameter Name="Animal" FormField="DdlTime" />
            <asp:FormParameter Name="Food" FormField="DdlTime" />
            <asp:FormParameter Name="Accident" FormField="DdlTime" />
             ...
             <WizardSteps>
                        ...
                        <asp:WizardStep ID="Wiz1" runat="server" title="Step 1">
                            <%--<asp:Label ID="Label1" runat="server" Text="Choose the day you have Asthma"></asp:Label>--%>
                              <asp:Label ID="Label8" runat="server" Text="When was the attack ?"></asp:Label>
                             <br />
                            <asp:Calendar ID="Calendar1" runat="server" BackColor="White" BorderColor="#3366CC"  CellPadding="1" DayNameFormat="Shortest"
                                ...
                                Width="250px" OnDayRender="Calendar1_DayRender" >
